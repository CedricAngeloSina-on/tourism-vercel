...
function ForcastLengthOfStayMenu() {
    ...
    return (
        ...
        >
            <DashboardTempB
                ...
                dashName1={"Average Length of Stay Forecast (" + nextYear + ")"}
                dashHint={
                ...
                barChart1Title={
                    `Forecasting Average Length of Stay Chart for ` + nextYear
                }
                barChart1Bold={` - ${selector}`}
                barChart1Hint={`Bar chart showing the average length of stay each month for ${dashboardName}`}
                ...
                barChart2Hint={
                    municipalityDefault || establishmentDefault
                        ? `Bar chart showing the average length of stay each month for ${
                              municipalityDefault?.name ||
                              establishmentDefault?.name
                          }`
                        : ""
...
export default ForcastLengthOfStayMenu;
