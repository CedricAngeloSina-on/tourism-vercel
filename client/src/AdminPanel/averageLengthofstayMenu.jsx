...
function LengthOfStayMenu() {
    ...
    function fetchBarChart2(filterType, filterValue, year, areaID) {
        ...
        fetchData(
            `${import.meta.env.VITE_WEBSITE_URL}/get_last_year_alos_by_area`,
            requestData,
            (data) => {
                setSpecificLastYearALOS(Number(data).toFixed(2));
            }
        );
        ...
        if (selector === "Overall") {
            axios
                .post(
                    `${
                        import.meta.env.VITE_WEBSITE_URL
                    }/get_alos_by_overall_by_area_barchart`,
                    requestData
                )
    ...
    return (
        ...
        >
            <DashboardTempA
                layoutArray={[
                    {
                        ...
                        hint: "General average of the lenght of stays in",
                    },
                ]}
                dataSelector={[
                    {
                ...
                dashName1={"Average Length of Stay"}
                dashHint={
                ...
                barChart1Title={`Average Length of Stay Chart`}
                barChart1Bold={` - ${selector}`}
                barChart1Hint={`Line chart showing the average length of stay each month for ${dashboardName}`}
                ...
                barChart2Title={"Average Length of Stay Chart"}
                barChart2Bold={
                ...
                barChart2Hint={
                    municipalityDefault || establishmentDefault
                        ? `Line chart showing the average length of stay each month for ${
                              municipalityDefault?.name ||
                              establishmentDefault?.name
                          }`
                        : ""
...
export default LengthOfStayMenu;
